...
import com.sigu.bpm.util.sample.web.MaskWeb;
...
public class ToolsController {
	...
	@Mapping(value = "com.sigu.bpm.util.openNotification", session = false, noSessionEvaluate = "用于集成第三方IM消息提醒", noSessionReason = "用于集成第三方IM消息提醒")
	...
	@Mapping("com.sigu.bpm.util.sample.maskForm")
	public String maskForm(UserContext uc) {
		MaskWeb web = new MaskWeb();
		String result = web.maskForm(uc);
		return result;
	}
}
